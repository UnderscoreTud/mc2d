...
public final class WitherSkullData extends BlockData implements HasPowered, HasRotation {
    ...
    @ApiStatus.Internal
    public WitherSkullData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "WitherSkullData[powered=" + String.valueOf(powered).toLowerCase(Locale.ENGLISH) + ";rotation=" + String.valueOf(rotation).toLowerCase(Locale.ENGLISH) + "]";
    }
}
