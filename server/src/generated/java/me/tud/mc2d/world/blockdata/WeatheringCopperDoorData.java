...
public final class WeatheringCopperDoorData extends BlockData implements HasFacing, HasOpen, HasPowered {
    ...
    private void hingeFromIndex(int index) {
        this.hinge(Hinge.values()[index]);
    }

    private void hingeFromString(String value) {
        this.hinge(Hinge.parse(value));
    }
    ...
    public enum Hinge {
        ...
        public static Hinge parse(String value) {
            return switch (value.toLowerCase(Locale.ENGLISH)) {
