...
public final class SmokerData extends BlockData implements HasFacing, HasLit {
    ...
    @ApiStatus.Internal
    public SmokerData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "SmokerData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";lit=" + String.valueOf(lit).toLowerCase(Locale.ENGLISH) + "]";
    }
}
