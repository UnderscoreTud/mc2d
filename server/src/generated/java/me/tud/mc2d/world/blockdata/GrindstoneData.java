...
public final class GrindstoneData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public GrindstoneData(Block<?> blockType, int startingID) {
    ...
    public String toString() {
        return blockType().key() + "[face=" + String.valueOf(face).toLowerCase(Locale.ENGLISH) + ";facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
