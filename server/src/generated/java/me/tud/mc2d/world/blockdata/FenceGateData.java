...
public final class FenceGateData extends BlockData implements HasFacing, HasPowered {
    ...
    @ApiStatus.Internal
    public FenceGateData(Block<?> blockType, int startingID) {
    ...
    public String toString() {
        return blockType().key() + "[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";in_wall=" + String.valueOf(inWall).toLowerCase(Locale.ENGLISH) + ";open=" + String.valueOf(open).toLowerCase(Locale.ENGLISH) + ";powered=" + String.valueOf(powered).toLowerCase(Locale.ENGLISH) + "]";
    }
}
