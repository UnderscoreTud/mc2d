...
public final class PistonBaseData extends BlockData implements HasFacing {
    private static final int EXTENDED_RADIX = 2;
    ...
    static final int MAX_OFFSET = EXTENDED_RADIX * FACING_RADIX - 1;
    ...
    @ApiStatus.Internal
    public PistonBaseData(Block<?> blockType, int startingID) {
    ...
    private int extendedToIndex() {
        return this.extended ? 0 : 1;
    }

    private void extendedFromIndex(int index) {
        this.extended(index == 0);
    }

    private void extendedFromString(String value) {
        this.extended(Boolean.parseBoolean(value));
    }
    ...
    int offsetID() {
        int id = 0;
        id = id * EXTENDED_RADIX + extendedToIndex();
    ...
    void loadFromOffset(int id) {
        ...
        extendedFromIndex(id % EXTENDED_RADIX); id /= EXTENDED_RADIX;
    }

    @Override
    public void load(Map<String, String> properties) {
        if (properties.containsKey("extended")) {
            extendedFromString(properties.get("extended"));
        }
    ...
    public String toString() {
        return blockType().key() + "[extended=" + String.valueOf(extended).toLowerCase(Locale.ENGLISH) + ";facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
