...
import me.tud.mc2d.world.blockdata.properties.HasHinge;
import me.tud.mc2d.world.blockdata.properties.HasOpen;
import me.tud.mc2d.world.blockdata.properties.HingeProperty;
...
public final class DoorData extends BlockData implements HasHinge, HasOpen {
    ...
    private static final int HINGE_RADIX = 2;

    private static final int OPEN_RADIX = 2;

    private static final int POWERED_RADIX = 2;

    static final int MAX_OFFSET = FACING_RADIX * HALF_RADIX * HINGE_RADIX * OPEN_RADIX * POWERED_RADIX - 1;
    ...
    private HingeProperty hinge = HingeProperty.LEFT;
    ...
    @ApiStatus.Internal
    public DoorData(int startingID) {
        super(startingID);
    }
    ...
    @Override
    public HingeProperty hinge() {
        return this.hinge;
    }

    @Override
    public void hinge(HingeProperty hinge) {
        Preconditions.checkNotNull(hinge, "hinge");
        this.hinge = hinge;
    }

    private int hingeToIndex() {
        return this.hinge.ordinal();
    }

    private void hingeFromIndex(int index) {
        this.hinge(HingeProperty.values()[index]);
    }

    private void hingeFromString(String value) {
        this.hinge(HingeProperty.parse(value));
    }
    ...
    int offsetID() {
        ...
        id = id * HINGE_RADIX + hingeToIndex();
    ...
    void loadFromOffset(int id) {
        ...
        hingeFromIndex(id % HINGE_RADIX); id /= HINGE_RADIX;
    ...
    public void load(Map<String, String> properties) {
        ...
        if (properties.containsKey("hinge")) {
            hingeFromString(properties.get("hinge"));
        }
    ...
    public String toString() {
        return "DoorData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";half=" + String.valueOf(half).toLowerCase(Locale.ENGLISH) + ";hinge=" + String.valueOf(hinge).toLowerCase(Locale.ENGLISH) + ";open=" + String.valueOf(open).toLowerCase(Locale.ENGLISH) + ";powered=" + String.valueOf(powered).toLowerCase(Locale.ENGLISH) + "]";
    }
