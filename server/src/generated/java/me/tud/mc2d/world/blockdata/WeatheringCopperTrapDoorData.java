...
public final class WeatheringCopperTrapDoorData extends BlockData implements HasFacing,
        HasOpen,
        HasPowered,
        HasWaterlogged {
    ...
    @ApiStatus.Internal
    public WeatheringCopperTrapDoorData(int startingID) {
        super(startingID);
    }
