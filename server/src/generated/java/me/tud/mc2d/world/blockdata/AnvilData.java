...
public final class AnvilData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public AnvilData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "AnvilData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
