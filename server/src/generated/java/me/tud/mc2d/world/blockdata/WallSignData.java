...
public final class WallSignData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    @ApiStatus.Internal
    public WallSignData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "WallSignData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";waterlogged=" + String.valueOf(waterlogged).toLowerCase(Locale.ENGLISH) + "]";
    }
}
