...
public final class FlowerBedData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public FlowerBedData(Block<?> blockType, int startingID) {
    ...
    public String toString() {
        return blockType().key() + "[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";flower_amount=" + String.valueOf(flowerAmount).toLowerCase(Locale.ENGLISH) + "]";
    }
}
