...
public final class WallBannerData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public WallBannerData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "WallBannerData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
