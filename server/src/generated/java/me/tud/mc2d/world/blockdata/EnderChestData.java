...
public final class EnderChestData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    @ApiStatus.Internal
    public EnderChestData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "EnderChestData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";waterlogged=" + String.valueOf(waterlogged).toLowerCase(Locale.ENGLISH) + "]";
    }
}
