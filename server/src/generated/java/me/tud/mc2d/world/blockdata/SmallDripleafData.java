...
public final class SmallDripleafData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    static final int MAX_OFFSET = FACING_RADIX * HALF_RADIX * WATERLOGGED_RADIX - 1;
    ...
    @ApiStatus.Internal
    public SmallDripleafData(Block<?> blockType, int startingID) {
    ...
    public String toString() {
        return blockType().key() + "[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";half=" + String.valueOf(half).toLowerCase(Locale.ENGLISH) + ";waterlogged=" + String.valueOf(waterlogged).toLowerCase(Locale.ENGLISH) + "]";
    }
