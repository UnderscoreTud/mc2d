...
public final class SmallDripleafData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    @ApiStatus.Internal
    public SmallDripleafData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "SmallDripleafData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";half=" + String.valueOf(half).toLowerCase(Locale.ENGLISH) + ";waterlogged=" + String.valueOf(waterlogged).toLowerCase(Locale.ENGLISH) + "]";
    }
