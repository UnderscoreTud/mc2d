...
public final class EndRodData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public EndRodData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "EndRodData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
