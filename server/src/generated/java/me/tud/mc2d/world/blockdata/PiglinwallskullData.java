...
public final class PiglinwallskullData extends BlockData implements HasFacing, HasPowered {
    ...
    @ApiStatus.Internal
    public PiglinwallskullData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "PiglinwallskullData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";powered=" + String.valueOf(powered).toLowerCase(Locale.ENGLISH) + "]";
    }
}
