...
public final class BigDripleafStemData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    @ApiStatus.Internal
    public BigDripleafStemData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "BigDripleafStemData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";waterlogged=" + String.valueOf(waterlogged).toLowerCase(Locale.ENGLISH) + "]";
    }
}
