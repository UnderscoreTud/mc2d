...
public final class FurnaceData extends BlockData implements HasFacing, HasLit {
    ...
    @ApiStatus.Internal
    public FurnaceData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "FurnaceData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";lit=" + String.valueOf(lit).toLowerCase(Locale.ENGLISH) + "]";
    }
}
