...
public final class EndPortalFrameData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public EndPortalFrameData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "EndPortalFrameData[eye=" + String.valueOf(eye).toLowerCase(Locale.ENGLISH) + ";facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
