...
public final class BigDripleafData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    private static final int TILT_RADIX = 4;

    private static final int WATERLOGGED_RADIX = 2;

    static final int MAX_OFFSET = FACING_RADIX * TILT_RADIX * WATERLOGGED_RADIX - 1;
    ...
    @ApiStatus.Internal
    public BigDripleafData(Block<?> blockType, int startingID) {
    ...
    public void tilt(Tilt tilt) {
        Preconditions.checkNotNull(tilt, "tilt");
        this.tilt = tilt;
    }

    private int tiltToIndex() {
        return this.tilt.ordinal();
    }

    private void tiltFromIndex(int index) {
        this.tilt(Tilt.values()[index]);
    }

    private void tiltFromString(String value) {
        this.tilt(Tilt.parse(value));
    }
    ...
    void loadFromOffset(int id) {
        ...
        tiltFromIndex(id % TILT_RADIX); id /= TILT_RADIX;
    ...
    public void load(Map<String, String> properties) {
        ...
        if (properties.containsKey("tilt")) {
            tiltFromString(properties.get("tilt"));
        }
    ...
    public String toString() {
        return blockType().key() + "[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";tilt=" + String.valueOf(tilt).toLowerCase(Locale.ENGLISH) + ";waterlogged=" + String.valueOf(waterlogged).toLowerCase(Locale.ENGLISH) + "]";
    }
    ...
    public enum Tilt {
        ...
        public static Tilt parse(String value) {
