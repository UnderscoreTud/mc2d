...
public final class WeatheringLightningRodData extends BlockData implements HasFacing, HasPowered, HasWaterlogged {
    ...
    static final int MAX_OFFSET = FACING_RADIX * POWERED_RADIX * WATERLOGGED_RADIX - 1;
    ...
    @ApiStatus.Internal
    public WeatheringLightningRodData(Block<?> blockType, int startingID) {
