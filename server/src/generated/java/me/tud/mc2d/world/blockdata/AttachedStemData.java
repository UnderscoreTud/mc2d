...
public final class AttachedStemData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public AttachedStemData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "AttachedStemData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
