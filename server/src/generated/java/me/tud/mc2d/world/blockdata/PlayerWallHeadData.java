...
public final class PlayerWallHeadData extends BlockData implements HasFacing, HasPowered {
    ...
    @ApiStatus.Internal
    public PlayerWallHeadData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "PlayerWallHeadData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";powered=" + String.valueOf(powered).toLowerCase(Locale.ENGLISH) + "]";
    }
}
