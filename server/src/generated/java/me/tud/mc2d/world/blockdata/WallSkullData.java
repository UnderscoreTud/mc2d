...
public final class WallSkullData extends BlockData implements HasFacing, HasPowered {
    ...
    @ApiStatus.Internal
    public WallSkullData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "WallSkullData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";powered=" + String.valueOf(powered).toLowerCase(Locale.ENGLISH) + "]";
    }
}
