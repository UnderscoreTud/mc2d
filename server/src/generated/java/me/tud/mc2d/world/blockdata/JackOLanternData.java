...
public final class JackOLanternData extends BlockData implements HasFacing {
    ...
    @ApiStatus.Internal
    public JackOLanternData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "JackOLanternData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + "]";
    }
}
