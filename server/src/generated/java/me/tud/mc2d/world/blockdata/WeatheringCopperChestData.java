...
public final class WeatheringCopperChestData extends BlockData implements HasFacing, HasWaterlogged {
    ...
    @ApiStatus.Internal
    public WeatheringCopperChestData(Block<?> blockType, int startingID) {
