...
public final class DropperData extends BlockData implements HasFacing, HasTriggered {
    ...
    @ApiStatus.Internal
    public DropperData(Block<?> blockType, int startingID) {
    ...
    public String toString() {
        return blockType().key() + "[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";triggered=" + String.valueOf(triggered).toLowerCase(Locale.ENGLISH) + "]";
    }
}
