...
public final class BarrelData extends BlockData implements HasFacing, HasOpen {
    ...
    @ApiStatus.Internal
    public BarrelData(int startingID) {
        super(startingID);
    }
    ...
    public String toString() {
        return "BarrelData[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";open=" + String.valueOf(open).toLowerCase(Locale.ENGLISH) + "]";
    }
}
