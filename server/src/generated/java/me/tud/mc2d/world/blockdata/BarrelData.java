...
public final class BarrelData extends BlockData implements HasFacing, HasOpen {
    ...
    static final int MAX_OFFSET = FACING_RADIX * OPEN_RADIX - 1;
    ...
    @ApiStatus.Internal
    public BarrelData(Block<?> blockType, int startingID) {
    ...
    public String toString() {
        return blockType().key() + "[facing=" + String.valueOf(facing).toLowerCase(Locale.ENGLISH) + ";open=" + String.valueOf(open).toLowerCase(Locale.ENGLISH) + "]";
    }
}
