 ...
 * <p>
 * <a href="https://github.com/MachineMC/Machine/blob/master/api/src/main/java/org/machinemc/api/utils/NamespacedKey.java">Source</a>
 */
public final class NamespacedKey implements Writable {
    ...
    /**
     * Returns Namespaced key with 'mc2d' namespace.
     * @param key key of the NamespacedKey
